...
def world_office_report(ws, report_data):
    row_titles = ["Empresa","Tipo Documento","prefijo","DocumentoNúmero","Fecha","Tercero Interno","Tercero Externo","Nota",
    ...
    for cell in ws[get_column_letter(36)]:
